...
$(document).ready(function() {
  ...
  $("#myFollowersTable").DataTable({
    order: [0, 'desc']
  });
  $("#myFollowingTable").DataTable({
    order: [0, 'desc']
  });
  $("#myBlockingTable").DataTable({
    order: [0, 'desc']
  });
  $("#myHistoryTable").DataTable({
    order: [0, 'desc']
  });
  $("#adminRecipesTable").DataTable({
    order: [0, 'desc']
  });
  ...
  $("#adminRecipeRatingsTable").DataTable({
    order: [0, 'desc']
  });
  $("#adminRecipeBuyersTable").DataTable({
    order: [0, 'desc']
  });
  $("#adminRecipeHistoryTable").DataTable({
    order: [0, 'desc']
  });
  $("#recipeRatingsTable").DataTable({
    order: [0, 'desc']
  });
  $("#recipeBuyersTable").DataTable({
    order: [0, 'desc']
  });
  $("#recipeHistoryTable").DataTable({
    order: [0, 'desc']
  });
});
